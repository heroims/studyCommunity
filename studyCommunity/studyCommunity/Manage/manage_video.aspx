<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manage_video.aspx.cs" Inherits="studyCommunity.manage_video" %>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            <Columns>
                <asp:HyperLinkField DataNavigateUrlFields="VideoID" 
                    DataNavigateUrlFormatString="manage_seeVideo.aspx？VideoID={0}" 
                    DataTextField="VideoName" HeaderText="视频名称">
                <ControlStyle Font-Underline="False" />
                </asp:HyperLinkField>
                <asp:BoundField HeaderText="发布日期" DataField="FBDate" />
                <asp:HyperLinkField HeaderText="管理留言" Text="管理" DataNavigateUrlFields="VideoID" 
                    DataNavigateUrlFormatString="manage_videoSpeak.aspx?VideoID={0}" >
                <ControlStyle Font-Underline="False" />
